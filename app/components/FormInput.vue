<template>
  ...
  /> -->
    <input 
      ...
      />
    <label 
      for="floating_first_name" class="peer-focus:font-medium absolute text-sm px-1 mt-2.5 bg-white text-zinc-400 duration-300 transform -translate-y-5 translate-x-2 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-sky-500  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-5 peer-focus:translate-x-2 peer-focus:z-20 peer-focus:px-1 overflow-visible">
        <slot></slot>
    </label>
  </div>
</template>
